...
<html lang="es">
  ...
  <body>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action = "" method = "POST">
                    ...
                    <select name="nombre_marca" id="nombre_marca"class="form-control">Marcas
                      <?php
    ...
    if(isset($_POST["submit"])){
            ...
            VALUES ('".$_POST["id"]."','".$_POST["nombre_marca"]."','".$_POST["nombre"]."','".$_POST["descripcion"]."','".$_POST["tipoCombustible"]."',
